...
#allow for network access
ignore net

#enable xorg sandboxing with xephyr
#set some xephyr options, consider moving to firejail config

#xephyr-screen 1024x768

#x11 xephyr
#enable hardened library for memory allocation
